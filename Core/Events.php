<?php
	...
	class Events {
		...
		public static function onActivate() {
			// check/generate invoice folder / .htaccess file if it is not existing
			gw_oxid_account_invoice_download::checkInvoiceDirectory();
...
/*			self::add_db_field('oxactions', 'gw_head', "VARCHAR(255) NOT NULL COMMENT 'action header lang 1'");*/
		...
		public static function onDeactivate() {
			...
			DatabaseProvider::getDb()->execute("DELETE FROM oxtplblocks WHERE oxshopid='".$config->getShopId()."' AND oxmodule='gw_oxid_account_invoice_download';");
